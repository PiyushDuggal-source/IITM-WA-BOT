var d=Object.create;var r=Object.defineProperty;var l=Object.getOwnPropertyDescriptor;var E=Object.getOwnPropertyNames;var u=Object.getPrototypeOf,c=Object.prototype.hasOwnProperty;var m=e=>r(e,"__esModule",{value:!0});var p=(e,o)=>{m(e);for(var n in o)r(e,n,{get:o[n],enumerable:!0})},y=(e,o,n)=>{if(o&&typeof o=="object"||typeof o=="function")for(let s of E(o))!c.call(e,s)&&s!=="default"&&r(e,s,{get:()=>o[s],enumerable:!(n=l(o,s))||n.enumerable});return e},a=e=>y(m(r(e!=null?d(u(e)):{},"default",e&&e.__esModule&&"default"in e?{get:()=>e.default,enumerable:!0}:{value:e,enumerable:!0})),e);p(exports,{GREETINGS:()=>f,HEY_EMOJIES:()=>S,HOLIDAY_REPLIES:()=>N,PING_REPLIES:()=>O,REACT_EMOGIES:()=>C,USER_COMMANDS:()=>I,USER_JOIN_GREETINGS:()=>b});var i=a(require("whatsapp-web.js")),R=a(require("../Commands/allCmds")),g=a(require("dotenv"));g.config();const O={admin:["Hello Sir \u{1F64F}","Need any help Sir?\u{1F647}\u200D\u2642\uFE0F","Aye aye Capn'","Yes Capn'","I am here Capn'"],adminMsgNumber:5,members:["Hey-Yo!","Hola","Yo \u270C","\u{1F918} hey","What iz up? I am UP!","\u{1F440} you called me? I am up!","Yes, my friend!","I am HERE!","I am Online!"],memberMsgNumber:9},h=e=>{const o=[];return e.forEach(n=>{n?.forEach((s,t)=>{t<3&&o.push({id:`${t}`,title:`${process.env.BOT_PREFIX}${s}`})})}),o},I=new i.List(`Hey.. Wanna checkout what ${process.env.BOT_NAME} can do?
