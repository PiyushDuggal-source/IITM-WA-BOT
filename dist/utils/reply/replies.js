"use strict";var R=Object.create;var a=Object.defineProperty;var l=Object.getOwnPropertyDescriptor;var S=Object.getOwnPropertyNames;var O=Object.getPrototypeOf,d=Object.prototype.hasOwnProperty;var u=(e,o)=>{for(var n in o)a(e,n,{get:o[n],enumerable:!0})},t=(e,o,n,r)=>{if(o&&typeof o=="object"||typeof o=="function")for(let s of S(o))!d.call(e,s)&&s!==n&&a(e,s,{get:()=>o[s],enumerable:!(r=l(o,s))||r.enumerable});return e};var c=(e,o,n)=>(n=e!=null?R(O(e)):{},t(o||!e||!e.__esModule?a(n,"default",{value:e,enumerable:!0}):n,e)),E=e=>t(a({},"__esModule",{value:!0}),e);var M={};u(M,{GREETINGS:()=>f,HEY_EMOJIES:()=>h,HOLIDAY_REPLIES:()=>B,PING_REPLIES:()=>I,RANDOM_WAKEUP_MSG:()=>G,REACT_EMOGIES:()=>b,USER_COMMANDS:()=>p,USER_JOIN_GREETINGS:()=>N});module.exports=E(M);var m=require("whatsapp-web.js"),i=require("../Commands/allCmds"),y=c(require("dotenv"));y.config();const I={admin:["Hello Sir \u{1F64F}","Need any help Sir?\u{1F647}\u200D\u2642\uFE0F","Aye aye Capn'","Yes Capn'","I am here Capn'"],adminMsgNumber:5,members:["Hey-Yo!","Hola","Yo \u270C","\u{1F918} hey","Here I am!","\u{1F440} you called me? I am up!","Yes, my friend!","I am HERE!","I am Online!"],memberMsgNumber:9},g=e=>{const o=[];return e.forEach(n=>{n==null||n.forEach((r,s)=>{s<3&&o.push({id:`${s}`,title:`${process.env.BOT_PREFIX}${r}`})})}),o},p=new m.List(`Hey.. Wanna checkout what ${process.env.BOT_NAME} can do?
