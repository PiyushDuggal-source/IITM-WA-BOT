...
Checkout these commands!! \u{1F609}`,"Commands",[{title:"These are the commands you can perform as a USER",rows:h(R.User_AllCommands)}]),f={admin:["Sir","Master","Monsieur"],adminMsgNumber:3,member:["Fellow","Good Person","Dude","Gentle-men/women","My Friend!","Good Guy","An IITian"],memberMsgNumber:8},N={members:[`FINALLY *IITian* you are *free*... but wait.. not so fast... THIS IS ONLY FOR THIS DAY... from next day... you will suffer again..... \u{1F608}
