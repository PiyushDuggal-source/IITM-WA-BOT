"use strict";var n=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var p=Object.getOwnPropertyNames;var y=Object.prototype.hasOwnProperty;var C=(o,a)=>{for(var e in a)n(o,e,{get:a[e],enumerable:!0})},M=(o,a,e,s)=>{if(a&&typeof a=="object"||typeof a=="function")for(let r of p(a))!y.call(o,r)&&r!==e&&n(o,r,{get:()=>a[r],enumerable:!(s=f(a,r))||s.enumerable});return o};var $=o=>M(n({},"__esModule",{value:!0}),o);var u={};C(u,{sendCalendar:()=>h});module.exports=$(u);var m=require("../resources/calendar"),t=require("date-fns"),d=require("../utils/reply/footers"),g=require("./sendMessage"),l=require(".."),c=require("./sendAndDeleteMsg");const i=o=>{let a="*This is you Calendar!!! \u{1F5D3}*";return o.forEach(e=>{e.date<new Date||(a+=`
 -------------------------------- 
